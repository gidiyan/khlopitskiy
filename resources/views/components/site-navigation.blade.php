    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-1 md:py-4">
        <div class="flex items-center justify-between md:justify-start">
            ...
            <div class="hidden md:flex space-x-3 flex-1 lg:ml-8">
                <a href="/" class="nav-link px-2 py-2 hover:bg-gray-100 rounded-lg text-gray-900 hover:text-gray-600"
                   :active="request()->routeIs('main')">Главная</a>
                <a href="/projects"
                   class="nav-link px-2 py-2 hover:bg-gray-100 rounded-lg text-gray-400 hover:text-gray-600">Проекты</a>
                <a href="/pricelist" class="nav-link px-2 py-2 hover:bg-gray-100 rounded-lg text-gray-400 hover:text-gray-600">Прайс</a>
