<nav class="z-50 shadow-sm sticky top-0 bg-gradient-to-b from-color1 to-color3  hover:from-color5 hover:to-color3">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-1 md:py-4">
        <div class="flex items-center justify-between md:justify-between">
            <!-- Menu Trigger -->
            <button type="button"
                    class="navbar-burger md:hidden w-10 h-10 rounded-lg -ml-2 flex justify-center items-center">
            ...
            <div id="main-nav"
                 class="toggle hidden md:flex w-full md:w-auto text-right text-bold mt-5 md:mt-0 md:border-none order-2">
                <a href="/"
                   class="nav-link px-2 py-2 hover:bg-gray-100 rounded-lg text-green-500 hover:text-gray-600 {{ (request()->routeIs('main')) ? 'active' : '' }}">Главная</a>
                <a href="/projects"
                ...
                <a href="/pricelist"
                   class="nav-link px-2 py-2 hover:bg-gray-100 rounded-lg text-gray-400 hover:text-gray-600 {{ (request()->routeIs('pricelist')) ? 'active' : '' }}">Прайс</a>
